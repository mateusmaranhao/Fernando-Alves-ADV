...
export function WhatsAppButton() {
  return (
    <a 
      ...
      className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#1EBE5D] text-white p-3 sm:p-4 rounded-full shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 focus-ring flex items-center justify-center"
    >
